...
const PreviousBtn = (props) => {
  ...
  return (
    <div className={className} onClick={onClick}>
      <ArrowBackIos style={{ backgroundColor: "black", color: "purple", fontSize: "45px" }} />
    </div>
  );
};
const NextBtn = (props) => {
  ...
  return (
    <div className={className} onClick={onClick}>
      <ArrowForwardIos style={{ backgroundColor: "black", color: "purple", fontSize: "45px" }} />
    </div>
  );
};
const Testimonial = () => {
  return (
    ...
    >
      <div style={{ backgroundColor: "black", width: "50%", textAlign: "center" }}>
        <h1 style={{ color: "purple", marginBottom: 20 }}>TESTIMONIALS</h1>
  ...
  return (
    ...
    >
      ...
      <p style={{ fontStyle: "italic", marginTop: 25 }}>
        <span style={{ fontWeight: 500, color: "purple" }}>Person</span> ,
        Developer
      </p>
    </div>
  );
